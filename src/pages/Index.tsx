    ...
    <div className="min-h-screen bg-background relative overflow-x-hidden">
      ...
      <section id="home" className="pt-32 pb-20 px-4 md:px-6 relative">
        <div className="container mx-auto">
          ...
          <div className="relative flex justify-center items-center mb-16 animate-fade-in">
            <div className="metamorphosis-float">
              <img 
                src="https://cdn.poehali.dev/files/d3a1897c-eb4c-4835-a08d-19981d2c5d24.jpg"
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
            <div className="space-y-6 animate-fade-in">
              ...
              <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
                ...
                <br /><br />
                Но настоящий прорыв происходит тогда, когда классика встречается с инновацией. Мой авторский метод трансформации — это следующий шаг в эволюции психологической помощи. Если классические подходы помогают понять "гусеницу", то метод трансформации позволяет ей стать "бабочкой" — помочь личности перейти на качественно новый уровень существования.
                <br /><br />
                Это не отрицание классики, а ее естественное развитие — научно обоснованный путь к полной реализации вашего потенциала.
              </p>
